...
def main():
    parser = argparse.ArgumentParser(description="Run llm_bench sweeps for H2O final.")
    ...
    parser.add_argument("--out-dir", default="exp/h2o_final/out")
    ...
    parser.add_argument("--kv-lossless-runtime-mode", default="full", choices=["probe", "full", "store"])
