...
def main():
    parser = argparse.ArgumentParser(description="Analyze parsed H2O v4 CSV metrics.")
    ...
    parser.add_argument("--out", default="exp/h2o_v4/out/summary.md")
