...
def main():
    ...
    parser.add_argument("--preset", required=True, help="Preset json, see exp/h2o_v4/configs/*.json")
    ...
    cmd = [
        sys.executable,
        str(Path(__file__).with_name("run_h2o_v4_bench.py")),
        "--llm-bench",
        args.llm_bench,
        "--base-config",
        args.base_config,
        ...
        str(preset.get("kv_lossless_kept_sample_token_interval", 1)),
