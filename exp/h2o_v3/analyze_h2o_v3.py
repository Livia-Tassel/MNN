...
def main():
    parser = argparse.ArgumentParser(description="Analyze parsed H2O v3 CSV metrics.")
    ...
    parser.add_argument("--out", default="exp/h2o_v3/out/summary.md")
    ...
    overall_pass = lossy_pass and online_lossless_pass and decode_pass

    out_path = Path(args.out)
    out_path.parent.mkdir(parents=True, exist_ok=True)
    with out_path.open("w", encoding="utf-8") as f:
        f.write("# H2O v3 Summary\n\n")
