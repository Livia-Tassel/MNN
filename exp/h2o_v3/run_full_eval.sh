...
if [[ $# -lt 3 ]]; then
  echo "Usage: $0 <out_dir> <dump_dir> <lossless_target> [decode_baseline] [decode_drop_target] [online_chunk_seq] [online_framing_bytes] [adaptive_block_seq]"
  echo "Example: $0 exp/h2o_v3/out_tune_v3_20260212 /home10T/ljq/MNN/exp/gear_fp16/dumps_fp16 1.3 6.72 0.05 192 12 64"
  exit 1
fi
