...
def main():
    ...
    parser.add_argument("--preset", required=True, help="Preset json, see exp/h2o_v6/configs/*.json")
    parser.add_argument("--out-dir", default="exp/h2o_v6/out")
    ...
    cmd = [
        sys.executable,
        str(Path(__file__).with_name("run_h2o_v6_bench.py")),
        "--llm-bench",
        args.llm_bench,
        "--base-config",
        args.base_config,
