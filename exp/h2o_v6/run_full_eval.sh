...
if [[ $# -lt 3 ]]; then
  ...
  echo "Example: $0 exp/h2o_v6/out_tune_v6_20260212 /home10T/ljq/MNN/exp/gear_fp16/dumps_fp16 1.3 6.72 0.05 192 12 64 chunked_grouped true 8 0 -1"
...
run_summary() {
  ...
  python3 exp/h2o_v6/analyze_h2o_v6.py "${args[@]}"
}
