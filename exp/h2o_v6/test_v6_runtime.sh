...
# ============================================================================
# H2O v6 Runtime Validation Script
# Coverage:
...
JSONEOF
set +e
EMPTY_OUT=$(python3 exp/h2o_v6/run_h2o_v6_bench.py \
  --llm-bench "${LLM_BENCH}" \
...
CSVEOF
GATE_OUT=$(python3 exp/h2o_v6/analyze_h2o_v6.py \
...
python3 exp/h2o_v6/run_h2o_v6_bench.py "${BENCH_ARGS[@]}" --dry-run
...
python3 exp/h2o_v6/run_h2o_v6_bench.py "${BENCH_ARGS[@]}" 2>&1 | tee "${BENCH_STDOUT_LOG}"
...
echo ""
echo "==== Step 4.2: Validating runtime decompression (v6 strict) ===="
