...
echo " ASYNC: threads=${KV_LOSSLESS_ASYNC_THREADS}, decode_cache_blocks=${KV_LOSSLESS_DECODE_CACHE_BLOCKS}"
echo "============================================================"
