...
def main():
    parser = argparse.ArgumentParser(description="Analyze parsed H2O v5 CSV metrics.")
    ...
    parser.add_argument("--out", default="exp/h2o_v5/out/summary.md")
