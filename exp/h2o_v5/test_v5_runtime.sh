...
# ============================================================================
# H2O v5 Runtime Validation Script
# Coverage:
...
#   - v5 strict runtime decode evidence (h2o_lossless_decomp_us > 0)
...
OUT="${OUT:-exp/h2o_v5/out_runtime_v5_$(date +%Y%m%d_%H%M%S)}"
...
echo "============================================================"
echo " H2O v5 Runtime Validation"
echo " OUT = ${OUT}"
echo "============================================================"
mkdir -p "${OUT}"
...
JSONEOF
set +e
EMPTY_OUT=$(python3 exp/h2o_v5/run_h2o_v5_bench.py \
  --llm-bench "${LLM_BENCH}" \
...
CSVEOF
GATE_OUT=$(python3 exp/h2o_v5/analyze_h2o_v5.py \
...
python3 exp/h2o_v5/run_h2o_v5_bench.py "${BENCH_ARGS[@]}" --dry-run
...
python3 exp/h2o_v5/run_h2o_v5_bench.py "${BENCH_ARGS[@]}" 2>&1 | tee "${BENCH_STDOUT_LOG}"
...
echo ""
echo "==== Step 4.2: Validating runtime decompression (v5 strict) ===="
python3 - "${OUT}/h2o_metrics.csv" <<'PY'
import csv
import re
import sys
...
python3 exp/h2o_v5/analyze_h2o_v5.py \
