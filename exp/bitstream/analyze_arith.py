...
def main() -> int:
    parser = argparse.ArgumentParser(description="Analyze Arithmetic-coded bitstream compression ratios.")
    ...
    csv_path = os.path.join(args.out_dir, "arith_metrics.csv")
    ...
    summary_path = os.path.join(args.out_dir, "arith_summary.md")
    with open(summary_path, "w", encoding="utf-8") as f:
        f.write("# Arithmetic Bitstream Summary\n\n")
